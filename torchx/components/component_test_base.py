...
class ComponentUtils:
    @classmethod
    def get_linter_errors(cls, file_path: str, function_name: str) -> List[LinterMessage]:
    ...
    @classmethod
    def get_linter_errors_for_component(cls, component: Callable[..., AppDef]) -> List[LinterMessage]:
        """
