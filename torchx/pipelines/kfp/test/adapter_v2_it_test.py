...
class TestPipelineCompilation(unittest.TestCase):
    ...
    def test_compile_simple_pipeline(self):
        ...
        @dsl.pipeline(name="torchx-pipeline", description="Pipeline with TorchX components")
        def torchx_pipeline():
        ...
        compiler.Compiler().compile(pipeline_func=torchx_pipeline, package_path=output_path)
    ...
    def test_compile_nested_pipeline(self):
        ...
        def outer_pipeline():
            ...
            # Postprocessing
            postprocessing = container_from_app(simple_app, display_name="Postprocessing")
