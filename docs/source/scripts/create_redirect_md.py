...
that redirects http://pytorch.org/torchx/<version>/<file_name>.html
to http://pytorch.org/torchx/latest/<file_name>.html
"""
...
if __name__ == "__main__":
    ...
    for rst_file in glob.glob(os.path.join(source_dir, "**/*.rst"), recursive=True):
        ...
        with open(md_file, "w") as f:
            ...
            f.write(f'redirect_url: "/torchx/{build_ver}/{html_relative_path}"\n')
            f.write("---\n")
